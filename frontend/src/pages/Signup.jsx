            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Arpit"
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 pl-10 text-white placeholder:text-muted-foreground text-sm focus:outline-none focus:border-[#eca8d6] focus:ring-1 focus:ring-[#eca8d6] transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••••••"
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 pl-10 pr-10 text-white placeholder:text-muted-foreground text-sm focus:outline-none focus:border-[#eca8d6] focus:ring-1 focus:ring-[#eca8d6] transition-all"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 px-6 bg-white hover:bg-white/90 text-black font-mono text-sm font-semibold rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-white/10 mt-2"
                >
                  {loading ? (
                    <>
              ...
              <div className="space-y-2.5">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-2.5 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white text-xs font-mono font-semibold flex items-center justify-center gap-3 transition-all cursor-pointer"
                >
              ...
              <div className="text-center pt-5 mt-5 border-t border-white/10">
                <p className="text-xs text-muted-foreground">
                  Already registered?{" "}
                  <Link to="/login" className="text-[#eca8d6] font-semibold hover:underline transition-colors">
                    Sign In
                  </Link>
                </p>
              </div>
