...
import { 
  ...
  AlertCircle, Loader2, ChevronRight, Layers, Command
} from "lucide-react";
...
export default function LandingPage({ initialAuthMode }) {
  ...
  // Requirement 5: Irrespective of login/signup, redirect straight to /dashboard!
        ...
        <div className="cf-modal-backdrop" onClick={() => setAuthModalOpen(false)}>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "20px" }}>
              <button className="cf-social-btn" onClick={() => handleSocialAuth("Google")}>
              ...
              <button className="cf-social-btn" onClick={() => handleSocialAuth("GitHub")}>
