...
const testimonials = [
  ...
  },
  {
    ...
    metric: { value: "2x", label: "Engineering velocity" },
  },
  {
    quote: "The ephemeral Docker sandboxes execute code with zero setup overhead. Plus 6-digit OTP auth gave our security team full peace of mind.",
  ...
  },
  {
    ...
    metric: { value: "0", label: "Security vulnerabilities" },
  },
];
...
export function TestimonialsSection() {
  ...
  useEffect(() => {
    // Generate the decorative ASCII pattern only on the client to avoid
    // SSR/client hydration mismatches from Math.random().
    setAsciiPattern(
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 bg-foreground text-background overflow-hidden">
      {/* ASCII background pattern (client-only, decorative) */}
      <div
        aria-hidden="true"
