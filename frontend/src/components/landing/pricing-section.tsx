...
const plans = [
  ...
  {
    name: "Developer",
    description: "For professionals and daily cloud IDE work",
    price: { monthly: 19, annual: 15 },
    features: [
      "Unlimited code runs",
      "High-priority Docker sandboxes",
      "Unlimited Gemini AI reviews",
      "Custom execution parameters",
      "6-digit OTP & OAuth security",
      "Priority support",
    ],
    cta: "Launch Developer Plan",
    highlight: true,
  },
  {
    name: "Enterprise",
